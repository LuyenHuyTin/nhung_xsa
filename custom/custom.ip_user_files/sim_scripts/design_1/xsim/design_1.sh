...
xv_boost_lib_path=/tools/Xilinx/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax -L axi_vip_v1_1_8 -L zynq_ultra_ps_e_vip_v1_0_8 -L xilinx_vip"
xvhdl_opts="--relax"
xsc_opts="-c --gcc_compile_options "-I../../../../custom.gen/sources_1/bd/design_1/ip/design_1_zynq_ultra_ps_e_0_0/sim_tlm -I../../../bd/design_1/ip/design_1_zynq_ultra_ps_e_0_0/sim -I$xv_boost_lib_path" -work xil_defaultlib -f xsc.prj"
...
compile()
{
  ...
  xsc $xsc_opts -f xsc.prj 2>&1 | tee compile.log
...
elaborate()
{
  xsc --shared -lib xil_defaultlib -lib remote_port_c_v4 -lib remote_port_sc_v4 -lib xtlm -lib zynq_ultra_ps_e_v3_3_3 -lib zynq_ultra_ps_e_v3_2_6 -o libdpi.so
  xelab --relax --debug typical --mt auto --include "../../../../custom.gen/sources_1/bd/design_1/ip/design_1_zynq_ultra_ps_e_0_0/sim_tlm" --include "../../../bd/design_1/ip/design_1_zynq_ultra_ps_e_0_0/sim" --include "$xv_boost_lib_path" -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_15 -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_2_5 -L axi_data_fifo_v2_1_21 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_22 -L axi_protocol_converter_v2_1_22 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm -sv_root "." -sc_lib libdpi --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xv_lib_path="/tools/Xilinx/Vivado/2020.2/lib/lnx64.o/Ubuntu:/tools/Xilinx/Vivado/2020.2/lib/lnx64.o"
...
{
  file="xsim.ini"
  lib_map_path="/tools/Xilinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
